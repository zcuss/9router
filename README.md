...
```bash
9route-zcus --low-memory --memory 512 -p 20128
```

Background mode:

```bash
9route-zcus --tray -p 20128
```
...
This repository package is private (`9route-zcus`), so source/Docker execution is the expected local development path.
